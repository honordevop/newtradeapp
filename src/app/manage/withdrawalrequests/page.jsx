...
const Dashboard = () => {
  ...
  const {
    ...
    mutate,
    isLoading,
  } = useSWR(`/api/manage/withdraw`, fetcher);

  // console.log(users?.users);
  // console.log(withdrawals?.allWithdrawals);
      ...
      <div className="relative w-full bg-[#191f3a]">
        ...
        <div className="flex ">
          ...
          <div className="bg-[#0c1023] h-max p-3 w-full">
            {/* <DashboardTop /> */}
            <h4 className="py-4">Withdrawal Requests</h4>
            {/* Status Card */}
            <div className="w-full">
              {/* <TradeviewSingleTicker /> */}
              <div className="h-[80vh] overflow-y-scroll">
                <WithdrawalTable records={withdrawals?.allWithdrawals || []} />
              </div>
            </div>
          </div>
        </div>
